import { fetchBlocknotes, blocknotesAdapter, blocknotesReducer } from '../blocknote.slice';
...
describe('blocknotes reducer', () => {
  ...
  it('should handle fetchBlocknotes', () => {
    ...
    state = blocknotesReducer(state, fetchBlocknotes.fulfilled([{ id: 1 }], ''));
    ...
    state = blocknotesReducer(state, fetchBlocknotes.rejected(new Error('Uh oh'), ''));
