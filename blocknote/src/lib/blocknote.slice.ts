 ...
 * ```
 */
export const fetchBlocknotes = createAsyncThunk<BlocknotesEntity[]>(
  'blocknotes/fetchStatus',
  async (_, thunkAPI) => {
    /**
...
export const initialBlocknotesState: BlocknotesState =
  blocknotesAdapter.getInitialState({
...
export const blocknotesSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(
        fetchBlocknotes.fulfilled,
        (state: BlocknotesState, action: PayloadAction<BlocknotesEntity[]>) => {
...
export const getBlocknotesState = (rootState: {
  [BLOCKNOTES_FEATURE_KEY]: BlocknotesState;
}): BlocknotesState => rootState[BLOCKNOTES_FEATURE_KEY];

export const selectAllBlocknotes = createSelector(
  getBlocknotesState,
  selectAll
);

export const selectBlocknotesEntities = createSelector(
  getBlocknotesState,
  selectEntities
);
